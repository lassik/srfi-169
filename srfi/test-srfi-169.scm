...
(define all-conforming '())
(define all-non-conforming '())
...
(conforming "0_1_23.4_5_6" 123.456)
(conforming "1_2_3.5e6" 123.5e6)
(conforming "1_2e1_2" 12e12)
...
(non-conforming "-12_3.0_00_00-12_34.56_78_i")
(non-conforming "-12_3.0_00_00-12_34.56_78i_")
(non-conforming "-12_3.0_00_00_@-12_34.56_78")
(non-conforming "-12_3.0_00_00@_-12_34.56_78")
...
(non-conforming "1_0+2_0_i-3_0j+4_0k")
(non-conforming "1_0+2_0i-3_0j_+4_0k")
(non-conforming "1_0+2_0i-3_0j+4_0k_")
...
(define (safe-read string-repr)
  (guard (err (else 'error))
    (parameterize ((current-input-port (open-input-string string-repr)))
      (read-procedure))))
